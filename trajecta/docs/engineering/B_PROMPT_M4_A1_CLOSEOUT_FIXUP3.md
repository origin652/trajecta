...
- `docs/engineering/TRAJECTA_M4_A1_A_FIXUP2_REVIEW.md`
...
更新 `docs/engineering/TRAJECTA_M4_A1_B_DELIVERY_REPORT.md`。必须列出新增负例测试名、runner 故障后实际文件集合、两个真实 production run 的五类 digest，以及 multi-hole topology validator 覆盖项。未闭合项标 blocked，不要只写 fixture passed。
