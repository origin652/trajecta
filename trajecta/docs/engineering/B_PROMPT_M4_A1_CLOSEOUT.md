...
更新 `docs/engineering/TRAJECTA_M4_A1_B_DELIVERY_REPORT.md`，逐项写 implemented/executed/passed/blocked，并列出 bundle/SQLite 路径、size、SHA、counts、worker/chunk/permutation digest。明确：未 commit、不宣称 M4-A1/M4 完成、未修改 A interval segmentation、未碰 `origo-validation-v1.json`。
