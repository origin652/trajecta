...
B 开始时先重算上述 summary SHA 并确认 artifact 完整。只补写 `docs/` 报告不会使该 binary 证据失效；
...
- `docs/TRAJECTA_M4_PARTICLE_LOOP_PLAN.md`（尤其 12.2～12.4、13）；
- `docs/TRAJECTA_M4_MODEL_ASSIGNMENT.md`（尤其 M4-A4、报告格式、Commit 规则）；
- `docs/TRAJECTA_M4_A2_A_COMPLETION_REPORT.md`；
- `docs/TRAJECTA_M4_A3_A_COMPLETION_REPORT.md`；
- 本 Prompt。
...
- `docs/TRAJECTA_M4_A4_B_EXECUTION_REPORT.md`：B 执行报告。
